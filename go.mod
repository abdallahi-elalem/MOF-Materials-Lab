...
require (
	...
	github.com/HugoBlox/hugo-blox-builder/modules/blox-plugin-reveal v1.1.3-0.20250301201144-44e75541f7be
	github.com/nicokaiser/hugo-theme-gallery/v4 v4.6.1 // indirect
)
